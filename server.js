...
async function insertnewuser(athlete_id, refresh_token, first_name, last_name){
  db.connect().then(conn => {
    ...
    console.log("INSERT INTO Testuser SET athleteID=" + athlete_id + ", first_name='" + first_name + "', last_name='" + last_name + "', refresh_token='" + refresh_token + "';");
    conn.query("INSERT INTO Testuser SET athleteID=" + athlete_id + ", first_name='" + first_name + "', last_name='" + last_name + "', refresh_token='" + refresh_token + "';");
